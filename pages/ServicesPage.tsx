    ...
    <div className="pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-24">
          <h2 className="text-purple-500 font-bold tracking-widest uppercase mb-4 animate-in fade-in slide-in-from-bottom-4">Our Expertise</h2>
            ...
            <div key={service.id} className={`flex flex-col lg:flex-row gap-20 items-center ${idx % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
              <div className="flex-1 relative group overflow-hidden rounded-[40px]">
                ...
                <img 
                  ...
                  className="relative rounded-[40px] border border-white/10 shadow-2xl w-full h-[500px] object-cover transform transition-transform duration-700 group-hover:scale-105"
                  alt={service.title}
                />
              </div>
              <div className="flex-1">
                ...
                <ul className="space-y-6">
                  {service.features.map((feature, i) => (
                    <li key={i} className="flex items-center gap-4 group">
                      <div className="w-8 h-8 rounded-full bg-purple-600/20 flex items-center justify-center text-purple-500 group-hover:bg-purple-600 group-hover:text-white transition-colors">
                ...
                <div className="mt-12">
                  <a href="#/contact" className="bg-white text-black px-8 py-3.5 rounded-full font-bold hover:bg-purple-500 hover:text-white transition-all inline-block purple-glow">견적 상담 요청</a>
                </div>
              </div>
            </div>
          ))}
