    ...
    <div className="w-full">
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          <div className="inline-block mb-6 px-4 py-1.5 rounded-full glass border-purple-500/30 text-purple-400 text-xs font-bold tracking-widest uppercase animate-in fade-in duration-1000">
          ...
          <p className="text-xl md:text-2xl text-gray-400 mb-12 max-w-3xl mx-auto font-light leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-1000">
      ...
      <section className="py-32 bg-neutral-950">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-black mb-6 uppercase tracking-tight">Our Services</h2>
            ...
            {(services || []).map((service, idx) => (
              <div key={service.id || idx} className="group relative overflow-hidden rounded-3xl glass border-white/5 h-[450px]">
                ...
                <div className="absolute bottom-0 p-10 w-full">
                  <span className="text-purple-500 font-black text-6xl opacity-10 absolute top-[-20px] left-8 select-none">0{idx + 1}</span>
                  <h3 className="text-2xl font-bold mb-4">{service.title}</h3>
                  <p className="text-gray-400 mb-6 text-sm leading-relaxed line-clamp-2">{service.description}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <div className="space-y-10">
                {[
                  { icon: ShieldCheck, title: "철저한 사후 관리", desc: "시공 후 발생하는 모든 문제에 대해 끝까지 책임지고 신속하게 대응합니다." },
                  { icon: Zap, title: "최첨단 정밀 장비", desc: "눈에 보이지 않는 오염까지 완벽하게 제거하기 위해 고성능 정밀 장비를 운용합니다." },
                  { icon: Award, title: "전문 자격 기술진", desc: "다년간의 현장 경험과 전문 자격을 보유한 베테랑들이 직접 시공합니다." }
                ].map((item, i) => (
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-2xl">
              <h2 className="text-4xl md:text-5xl font-black mb-6 uppercase tracking-tight">Successful Stories</h2>
              ...
              <div key={item.id} className="group cursor-pointer">
                <div className="relative aspect-[4/3] overflow-hidden rounded-2xl mb-6 border border-white/5">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className="glass px-3 py-1 rounded-md text-xs font-bold text-purple-400 border-white/10">{item.category}</span>
                  </div>
                </div>
